...
GPL은 이후 오픈소스 라이선스의 대표적인 모델이 되었으며, 많은 오픈소스 프로젝트가 이를 채택했습니다.
  ...
  - 상업 소프트웨어와의 갈등
    - 1980년대는 상업 소프트웨어가 급성장하며 소스 코드 접근이 제한되는 추세가 강화되었습니다.
    - 특히, 기업들이 소프트웨어를 폐쇄적으로 개발하고 배포하면서 사용자들의 권한이 점점 줄어들었습니다.
...
이런 변화에 맞서 자유 소프트웨어 운동이 성장하며, 소프트웨어의 자유와 접근성을 강조하게 되었습니다.
  ...
  - X 윈도우 시스템의 개발 (1984년)
    - MIT에서 X 윈도우 시스템(X Window System)이 개발되었습니다.
    - X 윈도우 시스템은 그래픽 사용자 인터페이스(GUI)를 제공하는 소프트웨어로, 오픈소스로 배포되었습니다.
    - 이 프로젝트는 자유 소프트웨어의 개발 및 배포의 대표적인 사례로 주목받았습니다.
  ...
  - ARPANET과 인터넷의 확산
    - 1980년대는 ARPANET이 인터넷으로 발전하면서 소프트웨어의 배포와 공유가 더욱 쉬워진 시기입니다.
    - 네트워크를 통해 전 세계 개발자들이 협업할 수 있는 환경이 조성되었으며, 이는 오픈소스 프로젝트가 빠르게 확산되는 데 기여했습니다.
- 1990년대 
